...
public class Main {
    ...
    /**
     * Método para iniciar la aplicación principal.
     */
            ...
            while (!opcionValida) {
                try {
                    ...
                    if (opcion >= 1 && opcion <= 3) {
                        ...
                        System.out.println("ERROR: Ingrese una opcion entre 1 y 3.");
    ...
    /**
     * Método para mostrar el menú inicial.
     */
    ...
    private static void iniciarSesion() {
        ...
        if (conn != null) {
            ...
            if (! credencialesValidas) {
                ...
                System.out.println("Verifique su contraseña y email, o registrese si no tiene cuenta.");
                return;
            }
    ...
    private static void registrarse() {
        ...
        if(cedula.length() != 10) {
            System.out.println("ERROR: Necesitas ingresar 10 digitos para la cedula.");
            return;
        }
        System.out.println("NOTA: El numero de cedula que ingreso se tomara para su contraseña");
        System.out.println("====================================================================");
        ...
        while (!generoValido) {
            if(genero.equals("M") || genero.equals("F")) {
                ...
                System.out.println("ERROR: Ingrese solo 'M' (Masculino) o 'F' (Femenino).");
                System.out.print("Genero (M/F): ");
        ...
        while (!telefonoValido) {
            try {
                ...
                if (telefono > 0) {
                    ...
                    System.out.println("ERROR: El telefono debe ser un numero positivo.");
                    System.out.print("Telefono: ");
                }
            } catch (java.util.InputMismatchException e) {
                System.out.println("ERROR: Ingrese un numero valido.");
    ...
    private static void registrarNuevoDocente(String cedula, String nombre, int edad,
        ...
        System.out.print("Carga Horaria (1-40): ");
        int carga = 0;
        ...
        while (!cargaValida) {
            try {
                ...
                if (carga > 0 && carga <= 40) {
                    ...
                    System.out.println("ERROR: La carga horaria debe estar entre 1 y 40 horas.");
                    System.out.print("Carga Horaria (1-40): ");
                }
            } catch (java.util.InputMismatchException e) {
                System.out.println("ERROR: Ingrese un numero valido.");
    ...
    /**
     * Método para registrar un nuevo administrativo.
     */
    ...
    /**
     * Método para mostrar el menú principal según el tipo de usuario.
     */
    ...
    /**
     * Método para mostrar el menú de estudiante.
     */
    ...
    /**
     * Método para mostrar el menú de docente.
     */
    ...
    private static void mostrarMenuDocente() {
        ...
        System.out.println("========================================");
        System.out.println("1. Ver y registrar Notas de Estudiantes");
        System.out.println("2. Ver y registrar Asistencias");
    ...
    /**
     * Método para mostrar el menú de administrativo.
     */
    ...
    private static void mostrarMenuAdministrativo() {
        ...
        System.out.println("3. Ver y registrar Notas");
        System.out. println("4. Ver y registrar Asistencia");
    ...
    /**
     * Método para gestionar las opciones del menú de estudiante.
     */
    ...
    /**
     * Método para gestionar las opciones del menú de docente.
     */
    ...
    /**
     * Método para gestionar las opciones del menú de administrativo.
     */
    ...
    /**
     * Método para gestionar notas de estudiantes (docente).
     */
    private static void gestionarNotasEstudiantes() {
        ...
        if(opcion == 1) {
            ...
            int parcial = 0;
            boolean parcialValido = false;
            while (!parcialValido) {
                try {
                    parcial = scanner.nextInt();
                    scanner.nextLine();
                    if (parcial > 0) {
                        parcialValido = true;
                    } else {
                        System.out.println("ERROR: El parcial debe ser un numero positivo.");
                        System.out.print("Ingrese el parcial: ");
                    }
                } catch (java.util.InputMismatchException e) {
    ...
    /**
     * Método para gestionar notas (administrativo).
     */
    ...
    /**
     * Método para gestionar asistencias (docente).
     */
    ...
    /**
     * Método para gestionar asistencias (administrativo).
     */
    ...
    /**
     * Método para inscribir estudiante en materia (docente).
     */
    ...
    /**
     * Método para ver estudiantes inscritos en la materia del docente.
     */
    ...
    /**
     * Método para gestionar empleabilidad (administrativo).
     */
    private static void gestionarEmpleabilidad() {
        ...
        if(opcion == 1) {
            ...
            if(!util.verificarUsuarioExiste(cedulaEmpleado, conn)) {
                System.out.println("ERROR: El empleado con cedula " + cedulaEmpleado + " no existe.");
                return;
            }
    ...
    /**
     * Método para ver el curso asignado al docente.
     */
    ...
    /**
     * Método para ver el horario del docente.
     */
    ...
    /**
     * Método para obtener un sueldo válido.
     */
    ...
    /**
     * Método para obtener horas trabajadas válidas.
     */
