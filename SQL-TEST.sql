...
CREATE TABLE IF NOT EXISTS `curso` (
  ...
  `docente_tutor_cedula` VARCHAR(20) NULL,
  PRIMARY KEY (`id_curso`),
  INDEX `idx_docente_tutor` (`docente_tutor_cedula`)
) ENGINE = InnoDB AUTO_INCREMENT = 1 DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci;
...
ALTER TABLE `curso`
  ADD CONSTRAINT `fk_curso_docente_tutor`
    FOREIGN KEY (`docente_tutor_cedula`)
...
CREATE TABLE IF NOT EXISTS `notas` (
  ...
  `observacion` VARCHAR(255) NULL,
  PRIMARY KEY (`id_nota`),
  UNIQUE INDEX `idx_nota_unica` (`estudiante_cedula`, `asignatura_id`, `parcial`),
  INDEX `idx_asignatura` (`asignatura_id`),
